            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <button id="btnsub"  class="btn btn-success" onclick="btnsubclick()">确认借阅</button>
                    </td>
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    function btnsubclick(){
        ...
        if(bookName==null||bookName==""||name==null||name==""){
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/borrowBook.do",
                data: {
                ...
                success: function(data) {
                    alert(data);
                    $("#table").load("${pageContext.request.contextPath}/jsp/borrowbook.jsp #table");
                }
